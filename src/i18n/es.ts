...
export const es: Translations = {
  ...
  loginPage: {
    ...
    brandSubtitle:   'Acceso a la Plataforma Institucional',
    title:           'Iniciar Sesión',
    intro:           'Ingresa tus credenciales para acceder a la plataforma.',
    errorMsg:        'Credenciales no válidas. Por favor verifica tus datos e inténtalo de nuevo.',
    userLabel:       'Usuario, Correo o Código Institucional',
    userPlaceholder: 'ej. usuario@colegio.edu o EST-2026-XXXX',
  ...
  app: {
    sidebar: {
      ...
      webLink:         'Web ↗',
      version:         'v1.0 · Supabase Cloud (Activo)',
    },
    topbar: {
