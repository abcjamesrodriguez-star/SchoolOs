...
export const en = {
  ...
  loginPage: {
    ...
    brandSubtitle:   'Institutional Platform Access',
    title:           'Sign In',
    intro:           'Enter your credentials to access the platform.',
    errorMsg:        'Invalid credentials. Please verify your details and try again.',
    userLabel:       'Username, Email, or Institutional ID',
    userPlaceholder: 'e.g. user@school.edu or EST-2026-XXXX',
    passLabel:       'Password',
    passPlaceholder: '••••••••',
  ...
  app: {
    sidebar: {
      ...
      settings:        'Settings',
      webLink:         'Web ↗',
      version:         'v1.0 · Supabase Cloud (Active)',
    },
    topbar: {
